  ...
  howItWorksStep3: [
    {
      ...
      lines: 20,
      content: `\
import { allPosts, type Post } from './data/wesjet-compiler'
      ...
      children: [
        {
          ...
          children: [
            ...
            {
              type: "file",
              name: "getting-started-with-wesjet.md.json",
              comment: "",
              tooltip: "Transformed data object representing the post content.",
            },
            {
              type: "file",
              name: "using-wesjet.md.json",
              comment: "",
              tooltip: "Transformed data object representing the post content.",
            },
          ],
      ...
      steps: [
        {
          ...
          cta: {
            ...
            url: "https://github.com/wesbitty/wesjetpkg/blob/master/examples/wesjet-starter",
          },
        ...
        },
        {
          ...
          text: (
            <>
              <p>
                Run Wesjet to process your content. Do this as part of the
                Next.js dev server, or using the Wesjet CLI.
              </p>
              <p>
...
export const HowItWorks: FC<{ codeSnippets: CodeSnippets }> = ({
  ...
  return (
    <div className="mx-auto mt-16 w-full max-w-screen-xl px-4 md:mt-24 md:px-8 lg:mt-32">
      <Tabs.Root
        defaultValue={content.tabs[0].title.toLowerCase().replace(/ /g, "-")}
      >
        ...
        {content.tabs
          ...
          .map(({ title, steps }, index) => (
            ...
            >
              ...
              {steps.map(
                (
                  { heading, text, cta, codeSnippetsKey, dataTransformation },
                  index
                ) => (
                  <div
                    key={index}
                    className="relative mt-16 grid grid-cols-1 gap-12 md:grid-cols-2 md:gap-16"
                  >
