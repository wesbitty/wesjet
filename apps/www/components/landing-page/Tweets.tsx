...
It transforms the mdx files, validates them AND adds types!`,
    person: {
      ...
      avatar:
        "https://pbs.twimg.com/media/FC9arX6XEAYZ9eE?format=jpg&name=large",
    },
...
Took me less than 5 minutes to cleanly separate and connect MDX files to a Next.js layout.`,
    person: {
      ...
      avatar:
        "https://pbs.twimg.com/profile_images/1460651862340915201/w8Zva6LO_400x400.jpg",
    },
  ...
  },
  {
    ...
    person: {
      ...
      avatar:
        "https://pbs.twimg.com/profile_images/694401960397570049/uIEsJzcv_400x400.jpg",
    },
  ...
  },
  {
    ...
    person: {
      ...
      avatar:
        "https://pbs.twimg.com/profile_images/1425192858412326912/dh_udEMJ_400x400.jpg",
    },
        ...
        {[...tweets, ...tweets, ...tweets].map((tweet, index) => (
          <li
            ...
            className={`m-0 shrink-0 grow-0 px-4 md:w-[560px] ${
              index >= tweets.length ? "hidden md:block" : "block"
            }`}
          >
            <Tweet {...tweet} />
          </li>
      ...
      <div className="md:hidden">
        ...
        {tweetsToShow < tweets.length && (
          <div className="flex w-full justify-center px-4 pt-8">
            <Button
              label="Show more"
              action={() => setTweetsToShow(tweetsToShow + 2)}
              theme="primary"
            />
          </div>
        )}
