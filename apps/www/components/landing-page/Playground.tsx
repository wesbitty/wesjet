  ...
  steps: [
    ...
    },
    {
      ...
      ideState: {
        openFiles: [
          "posts/change-me.md",
          ".contentlayer/generated/Post/change-me.md.json",
        ],
        focusIndex: 1,
        url: "/",
        view: "editor",
      ...
      hints: {
        editor:
          "Each content file (e.g. MDX) is transformed into a JSON document ...",
    ...
    },
    {
      ...
      hints: {
        editor:
          "Content is simply imported as data and used in your components",
    ...
    },
    {
      ...
      hints: {
        editor:
          "The Contentlayer config contains your document type definitions",
...
export const Playground: FC = () => {
  ...
  const [stackblitzIDEState, setStackblitzIDEState] =
    useState<StackblitzIDEState>({
      openFiles: ["posts/change-me.md"],
      url: "",
      view: "default",
    });
          ...
          <div className="px-8">
            {content.steps[selectedStep].hints?.editor && (
              <div className="flex space-x-4">
                ...
                <Arrow
                  type="curved-short"
                  className="w-16 shrink-0 text-slate-700 lg:w-24"
                />
              </div>
            )}
          </div>
          <div className="px-8">
            {content.steps[selectedStep].hints?.preview && (
              <div className="mb-2 flex space-x-4">
                ...
                <Arrow
                  type="looped-long"
                  className="mt-2 w-28 shrink-0 rotate-12 text-slate-700 lg:w-40"
                />
              </div>
            )}
          </div>
          ...
          {content.steps[selectedStep].hints?.console && (
            <div className="flex items-start space-x-4 pl-48 lg:pl-96">
              <Arrow
                ...
                className="w-32 shrink-0 rotate-180 text-slate-700 lg:w-40"
              />
...
> = ({
  ...
  const [currentView, setCurrentView] =
    useState<Stackblitz.OpenOptions["view"]>(view);
  ...
  useEffect(() => {
    ...
    const check = async () => {
      ...
      if (
        fileNames.includes(".contentlayer/generated/Post/change-me.md.json")
      ) {
