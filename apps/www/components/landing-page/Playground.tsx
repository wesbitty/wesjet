  ...
  steps: [
    {
      ...
      ideState: {
        openFiles: ['posts/editing-content.md'],
        url: '/',
        view: 'default',
      },
      hints: {
    ...
    },
    {
      ...
      ideState: {
        openFiles: ['posts/editing-content.md', '.wesjet/jetpack/Post/editing-content.md.json'],
        focusIndex: 1,
        url: '/',
        view: 'editor',
      },
        ...
        <Card shadow dark>
          ...
          <div className="overflow-hidden">
            <StackblitzIDE
              ...
              repoSlug="wesbitty/nextjs-with-wesjet"
...
> = ({ className, repoSlug, setEditorIsReady, openFiles, focusIndex, url, view }) => {
  ...
  useEffect(() => {
    ...
    const check = async () => {
      ...
      if (fileNames.includes('.wesjet/jetpack/Post/editing-content.md.json')) {
