...
Nested types are defined within document type definitions, and therefore do not have to be included in the [`makeSource` options](./reference/maker/make-source).
...
Field definitions determine the data shape for the document type. See [the field types reference](./reference/maker/field-types) for more information.
