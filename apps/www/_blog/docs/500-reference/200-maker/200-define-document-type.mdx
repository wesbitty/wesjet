...
Document type definitions are used within the options for [`makeSource`](/docs/reference/maker/make-source), which is how the definition is passed onto Wesjet.
...
Field definitions determine the data shape for the document type. See [the field types reference](/docs/reference/maker/field-types) for more information.
