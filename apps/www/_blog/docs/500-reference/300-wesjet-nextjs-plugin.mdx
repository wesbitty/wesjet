...
<Callout>
  Remember to set `contentType: 'mdx'` in your config for proper [processing of
  MDX files](/docs/sources/files/mdx).
</Callout>

For a more holistic view of using MDX in a project, refer to [the example Next.js project](https://github.com/wesbitty/wesjetpkg/blob/master/examples/wesjet-starter).
