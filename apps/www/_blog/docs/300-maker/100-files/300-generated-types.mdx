...
excerpt: Wesjet automatically generates type definitions for content that lives locally.
---
...
A type is generated for every document and nested type you've defined in your Wesjet configuration.
