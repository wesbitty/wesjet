...
Using TypeScript is how you can get the most out of Wesjet. Wesjet automatically compiles type definitions for the transformed content. No extra work or configuration is required.
