...
<div className="mt-8 grid gap-6 md:grid-cols-2">
  <Card title="Try it Now" icon="gitpod" link={{url: 'http://gitpod.io/#https://github.com/wesbitty/nextjs-with-wesjet', label: 'Try in Gitpod'}}>
    If you'd like to dive right in and start playing with Wesjet, you can open the project in Gitpod.

  </Card>
  <Card title="Example Project" icon="github" link={{url: 'https://github.com/wesbitty/nextjs-with-wesjet', label: 'See example'}}>
    You can find a working version of this tutorial in [this state](https://github.com/wesbitty/nextjs-with-wesjet/tree/bca4b7884f5cad8963e631a2f24a19200c106495) of the example project.
