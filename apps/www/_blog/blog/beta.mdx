...
<BulletList>
  <BulletListItem type="cross">
    Write **markdown processing logic**, including working with
  ...
  <BulletListItem type="cross">
    Implement **content validation** to make sure your content matches the
    structure expected by your application.
  </BulletListItem>
  <BulletListItem type="cross">
    **Cache** processed content data to avoid unnecessary work. But _caching is
    hard_ and _Not caching_ degrades the developer experience and build
    performance.
  </BulletListItem>
  <BulletListItem type="cross">
    **Incrementally regenerate** only the content you changed to optimize
    rebuild/reload performance.
  </BulletListItem>
  <BulletListItem type="cross">
    Account for rich and complex **content relations**, so that objects can live
    as individual content files but be embedded as necessary when used as data.
  </BulletListItem>
  <BulletListItem type="cross">
    Most frameworks (e.g Next.js) don't support **content live-reload**.
    Building this yourself is usually very complicated.
  </BulletListItem>
  <BulletListItem type="cross">
    If you want to work with **TypeScript** and have strongly-typed data, you
    must write those types manually and hope that the content data matches your
    types.
  </BulletListItem>
</BulletList>
...
<div className="my-24 xl:-mx-40">
  <Playground
    githubRepo="wesbitty/wesjetpkg/tree/master/examples/wesjet/starter"
    openFile="posts/documentation.md"
  />
</div>

- The content is compile into a `.wesjet/jetpack` directory that includes JSON content caches, exported collections of data, and automatically compile types.
...
<BulletList>
  <BulletListItem type="check">
    **Content just works**: Gone are the days of writing low-level
    content-processing logic. Instead, you set the rules and the content _just
    works_.
  </BulletListItem>
  <BulletListItem type="check">
    **TypeScript Support**: Auto-generated TypeScript type definitions every
    document type.
  </BulletListItem>
  <BulletListItem type="check">
    <div className="mb-4">
      **Content validation:** Content is validated automatically with helpful
      error messages.
    </div>
  </BulletListItem>
  <BulletListItem type="check">
    **Caching**: Content builds are cached and incrementally regenerated - doing
    only the minimal amount of work necessary when changing your content.
  </BulletListItem>
  <BulletListItem type="check">
    **Live reload**: The browser will automatically reload after changing
    content for those frameworks that support live reloading.
  </BulletListItem>
  <BulletListItem type="check">
    **Flexible content modeling**: Wesjet allows you to structure your content
...
We put our claims to the test and [built a simple benchmark study](https://github.com/wesbitty/wesjetpkg-benchmarks) that compared a Next.js site with 1,000+ markdown content files to the same site using a DIY content processing method. We then built the same site with Gatsby.

<div className="my-8 space-y-4">
  <Image
    src="https://i.imgur.com/RL2t7es.png"
    alt="Wesjet Performance Comparison"
    width="2560"
    height="1200"
  />
...
- Add support for more content sources (e.g. [Contentful](https://github.com/wesbitty/wesjetpkg/issues/173), [Notion](https://github.com/wesbitty/wesjetpkg/issues/174), ...) and even supporting [multiple content sources](https://github.com/wesbitty/wesjetpkg/issues/84) in a single project
- Providing seamless integrations for more site frameworks (such as [Vite](https://github.com/wesbitty/wesjetpkg/issues/179), [Remix](https://github.com/wesbitty/wesjetpkg/issues/169), [Astro](https://github.com/wesbitty/wesjetpkg/issues/171), ...)
...
- Reporting issues in the [GitHub repository](https://github.com/wesbitty/wesjetpkg) - Please also consider starring the repo 🌟
...
- All contributors for [reporting and investigating issues](https://github.com/wesbitty/wesjetpkg/issues)
