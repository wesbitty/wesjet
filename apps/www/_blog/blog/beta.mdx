...
<div className="my-24 xl:-mx-40">
  <Playground
    githubRepo="contentlayerdev/next-contentlayer-example"
...
<BulletList>
  ...
  <BulletListItem type="check">
    **Flexible content modeling**: Contentlayer allows you to structure your
    content in a flexible and powerful way.
  </BulletListItem>
</BulletList>
