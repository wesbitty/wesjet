...
<BulletList>
  ...
  <BulletListItem type="check">
    **TypeScript support:** Strong-typed data (TypeScript types are compile automatically){'\n'}
    {'\n'}
  </BulletListItem>
  <BulletListItem type="check">
...
<Callout className="mt-8">
  Learn more about Wesjet by reading [the launch post](/blog/beta) or [getting started](/docs/getting-started)
  today!
</Callout>