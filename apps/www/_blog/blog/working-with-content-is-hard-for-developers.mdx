...
<BulletList>
  ...
  <BulletListItem type="check">
    **TypeScript support:** Strong-typed data (TypeScript types are generated
    automatically){"\n"}
    {"\n"}
  </BulletListItem>
  <BulletListItem type="check">
...
<Callout className="mt-8">
  Learn more about Contentlayer by reading [the launch post](/blog/beta) or
  [getting started](/docs/getting-started) today!
</Callout>
