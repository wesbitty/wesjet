...
describe("getDataForFieldDef", () => {
  ...
  test("only year", () =>
    testValue({
      type: "date",
      rawFieldData: "2022",
      expectedValue: "2022-01-01T00:00:00.000Z",
    }));
  ...
  test("date with slash separators", () =>
    testValue({
      ...
      expectedValue: "2022-10-12T00:00:00.000Z",
    }));
...
const runPromise = <A>(
  eff: T.Effect<
    OT.HasTracer & HasClock & HasConsole & HasDocumentContext & HasCwd,
    unknown,
    A
  >
) =>
