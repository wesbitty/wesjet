...
export const DocumentContext = tag<DocumentContext>(
  Symbol.for("@wesjet/maker/DocumentContext")
);

export const provideDocumentContext = (_: DocumentContext) =>
  T.provideService(DocumentContext)(_);
...
export const getFromDocumentContext = <K extends keyof DocumentContext>(
  key: K
