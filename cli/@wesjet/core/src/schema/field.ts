...
export const isNestedPolymorphicFieldDef = (
  _: FieldDef
): _ is NestedPolymorphicFieldDef => _.type === "nested_polymorphic";
...
export const isNestedUnnamedFieldDef = (
  _: FieldDef
): _ is NestedUnnamedFieldDef => _.type === "nested_unnamed";
...
export const isReferenceField = (_: FieldDef): _ is ReferenceFieldDef =>
  _.type === "reference";
