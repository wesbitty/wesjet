  ...
  const models = Object.fromEntries(
    [
      ...pageDocumentDefs.map((def) =>
        documentOrObjectDefToStackbitYamlModel({
          def,
          type: "page",
          urlPathFieldName,
        })
...
const documentOrObjectDefToStackbitYamlModel = ({
  ...
  switch (type) {
    ...
    case "config":
      return {
        name,
        model: { ...modelCommon, type: "config", singleInstance },
      };
    case "object":
  ...
  switch (fieldDef.type) {
    ...
    case "reference":
      return {
        ...commonField,
        type: "reference",
        models: [fieldDef.documentTypeName],
      };
    case "reference_polymorphic":
      return {
        ...commonField,
        type: "reference",
        models: fieldDef.documentTypeNames as string[],
      };
    case "nested":
      return {
        ...commonField,
        type: "model",
        models: [fieldDef.nestedTypeName],
      };
    case "nested_polymorphic":
      return {
        ...commonField,
        type: "model",
        models: fieldDef.nestedTypeNames as string[],
      };
    case "nested_unnamed":
      return {
        ...commonField,
        ...
        fields: fieldDef.typeDef.fieldDefs
          ...
          .map((fieldDef) =>
            fieldDefToStackbitField({ fieldDef, fieldExtension: undefined })
          ),
      };
    case "json":
    ...
    case "list_polymorphic":
      return {
        ...commonField,
        type: "list",
        items: listFieldDefToStackbitFieldListItems(fieldDef),
      };
    case "image":
...
const listFieldDefToStackbitFieldListItems = (
  ...
  const getModelName = (
    item:
      | core.ListFieldDefItem.ItemNested
      | core.ListFieldDefItem.ItemDocumentReference
  ) =>
