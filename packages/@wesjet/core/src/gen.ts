...
export type GetDocumentTypeMapGen<TDocument extends Document> = WesjetGen extends { documentTypeMap: infer T }
  ? T
...
export type GetDocumentTypeNamesGen = WesjetGen extends { documentTypeNames: infer T } ? T : string
...
export type GetNestedTypeNamesGen = WesjetGen extends { objectTypeNames: infer T } ? T : string
