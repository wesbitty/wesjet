...
export const tapSkipFirstRight =
  ...
  ): S.Stream<R1 & R2, E1 | E2, E.Either<EE1, A1>> =>
    pipe(
      stream,
      S.zipWithIndex,
...
export const tapRight =
  ...
  (
    stream: S.Stream<R1, E1, E.Either<EE1, A1>>
  ): S.Stream<R1 & R2, E1, E.Either<EE1, A1>> =>
    pipe(
      stream,
...
export const tapRightEither =
  <R1, R2, E1, EE1, EE2, A1>(
    f: (o: A1) => T.Effect<R2, never, E.Either<EE2, unknown>>
  ) =>
  (
    stream: S.Stream<R1, E1, E.Either<EE1, A1>>
  ): S.Stream<R1 & R2, E1, E.Either<EE1 | EE2, A1>> =>
    pipe(
      stream,
      S.tap((val) => (E.isLeft(val) ? T.succeed(null) : f(val.right)))
    );
...
export const chainMapEitherRight =
  <R2, E2, EE2, A2, A1>(
    mapRight: (a1: A1) => S.Stream<R2, E2, E.Either<EE2, A2>>
  ) =>
  <R1, E1, EE1>(
    stream: S.Stream<R1, E1, E.Either<EE1, A1>>
...
export const mapEffectEitherRight =
  <R2, E2, A2, A1>(
    mapRight: (a1: A1) => T.Effect<R2, never, E.Either<E2, A2>>
  ) =>
  <R1, E1>(
    stream: S.Stream<R1, never, E.Either<E1, A1>>
